...
export const createExperience =
  (userId: string, expData: ExperienceInput) => async (dispatch: Dispatch) => {
    dispatch({ type: EXP_LOADING })
    try {
      const data = await customFetch<Experience>(
        `profile/${userId}/experiences`,
...
export const updateExperience =
  (userId: string, expId: string, expData: ExperienceInput) =>
...
export const deleteExperience =
  (userId: string, expId: string) => async (dispatch: Dispatch) => {
    dispatch({ type: EXP_LOADING })
    try {
