      ...
      {myProfile && (
        <BsNavbar bg="white" className="border-bottom py-0 linkedin-navbar">
          ...
          >
            ...
            <Dropdown.Toggle as="div" className="linkedin-item linkedin-business">
              <FaTh />
              <span>
            ...
            <Dropdown.Menu align="end" className="linkedin-business-menu p-0">
              <div className="d-flex">
                ...
                <div className="business-right p-4">
                  <h6 className="fw-bold mb-4">Scopri altro per il business</h6>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="small mb-0">Sblocca nuove opportunità di vendita</p>
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="small mb-0">Amplia e sfrutta la tua rete</p>
                  </div>

                  <div className="mb-4">
                    <strong>Impara con LinkedIn</strong>
                    <p className="small mb-0">Corsi per formare i tuoi dipendenti</p>
                  </div>
